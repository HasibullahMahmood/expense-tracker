	...
	return (
		<form action="" className="new-expense__controls" onSubmit={ submitHandler}>
			...
			<div className="new-expense__control">
				...
				<input type="number" name="amount" min="0.01" step="0.01" onChange={amountChangeHandler} value={ amount}/>
			</div>
			<div className="new-expense__control">
				<label htmlFor="date">Date</label>
				<input type="date" name="date" min="2019-01-01" max="2022-12-31" onChange={dateChangeHandler} value={ date}/>
			</div>
